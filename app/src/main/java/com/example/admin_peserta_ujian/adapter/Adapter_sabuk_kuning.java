...
public class Adapter_sabuk_kuning extends RecyclerView.Adapter<Adapter_sabuk_kuning.SabukkuningViewHolder> {
    private ArrayList<Lihat_Peserta> datalist;
    private Context context;
    private Adapter_sabuk_kuning.FirebaseDataListener listener;

    public Adapter_sabuk_kuning(ArrayList<Lihat_Peserta> datalist, Context context) {
        this.datalist = datalist;
        this.context = context;
        listener = (Sabuk_kuning)context;
    }

    @Override
    public Adapter_sabuk_kuning.SabukkuningViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_data_peserta,parent,false);
        SabukkuningViewHolder vh = new SabukkuningViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_sabuk_kuning.SabukkuningViewHolder holder, final int position) {
    ...
    public class SabukkuningViewHolder extends RecyclerView.ViewHolder {
        private TextView instansi, nama, sabuk,bb,konfirmasi;
        private CardView cardpeserta;


        public SabukkuningViewHolder(@NonNull View itemView) {
            super(itemView);
