...
public class Adapter_sabuk_merah extends RecyclerView.Adapter<Adapter_sabuk_merah.SabukmerahViewHolder> {
    private ArrayList<Lihat_Peserta> datalist;
    private Context context;

    public Adapter_sabuk_merah(ArrayList<Lihat_Peserta> datalist, Context context) {
        this.datalist = datalist;
        this.context = context;
    }

    @Override
    public Adapter_sabuk_merah.SabukmerahViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_data_peserta,parent,false);
        SabukmerahViewHolder vh = new SabukmerahViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_sabuk_merah.SabukmerahViewHolder holder, int position) {
    ...
    public class SabukmerahViewHolder extends RecyclerView.ViewHolder {
        private TextView instansi, nama, sabuk,bb,konfirmasi;
        private CardView cardpeserta;


        public SabukmerahViewHolder(@NonNull View itemView) {
            super(itemView);
