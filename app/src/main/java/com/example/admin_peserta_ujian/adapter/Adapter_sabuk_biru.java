...
public class Adapter_sabuk_biru extends RecyclerView.Adapter<Adapter_sabuk_biru.SabukbiruViewHolder> {
    private ArrayList<Lihat_Peserta> datalist;
    private Context context;

    public Adapter_sabuk_biru(ArrayList<Lihat_Peserta> datalist, Context context) {
        this.datalist = datalist;
        this.context = context;
    }

    @Override
    public Adapter_sabuk_biru.SabukbiruViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_data_peserta,parent,false);
        SabukbiruViewHolder vh = new SabukbiruViewHolder(view);
        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_sabuk_biru.SabukbiruViewHolder holder, int position) {
    ...
    public class SabukbiruViewHolder extends RecyclerView.ViewHolder {
        private TextView instansi, nama, sabuk,bb,konfirmasi;
        private CardView cardpeserta;


        public SabukbiruViewHolder(@NonNull View itemView) {
            super(itemView);
